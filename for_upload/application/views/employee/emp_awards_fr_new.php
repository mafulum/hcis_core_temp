    ...
    <div class="col-lg-12">
        ...
        <section class="panel">
            ...
            <div class="panel-body">
                <form class="form-horizontal" role="form" action="<?php echo $base_url; ?>index.php/employee/emp_awards_new" method="post" name="fr_new" id="fr_new">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-10">
                            <input class="form-control form-control-inline input-medium default-date-picker" name="begda" id="begda"  size="16" type="text" value="" />
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="input3" class="col-lg-2 col-sm-2 control-label">Achievement Type</label>
                        <div class="col-lg-10">
                            <input type="text" class="form-control" id="awdtp" name="awdtp" value="" style="padding: 3px 0px;">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="input4" class="col-lg-2 col-sm-2 control-label">Note</label>
                        <div class="col-lg-10">
                            <input type="text" class="form-control" id="text1" name="text1" value="">
                        </div>
                    </div>
                    <div class="form-group">
