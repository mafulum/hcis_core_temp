    ...
    <div class="col-lg-12">
        ...
        <section class="panel">
            ...
            <div class="panel-body">
                <form class="form-horizontal" role="form" action="<?php echo $base_url; ?>index.php/employee/emp_compt_new" method="post" id="fr_new" name="fr_new">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-10">
                            <input style="padding: 3px 0px;" type="text" class="form-control" id="compt" name="compt">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="coval" class="col-lg-2 col-sm-2 control-label">Value</label>
                        <div class="col-lg-10">
                            <input type="text" class="form-control" id="coval" name="coval">
                        </div>
                    </div>
                    <div class="form-group">
