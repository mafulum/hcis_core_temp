...
RUN docker-php-ext-install curl tokenizer mcrypt mysqli json pdo pdo_mysql pgsql pdo_pgsql mbstring zip exif pcntl gd xsl bcmath gmp bz2 calendar ctype curl ftp phar posix session simplexml snmp soap sockets sysvmsg sysvsem sysvshm tidy xml
