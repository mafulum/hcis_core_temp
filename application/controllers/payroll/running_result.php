...
//        exit;
    ...
    private function reconfirm_detail($payroll_code,$sJsonPernr) {
        ...
        $curl = curl_init();
        $url = 'http://localhost:8001//payroll/employee/reconfirm' . "?" . $data;
...
//        echo $response;exit;
    ...
    private function confirm_detail($payroll_code = null) {
        ...
        $data = http_build_query($paramAPI);
        $curl = curl_init();
        $url = 'http://localhost:8001/payroll/employee/confirm' . "?" . $data;
//        if($this->session->userdata('username')=='mafulum'){
...
//        echo $url;exit;
    ...
    public function running_result_detail_load() {
        ...
        $data = http_build_query($paramAPI);
        $curl = curl_init();
        $url = 'http://localhost:8001/payroll/open_parquet' . "?" . $data;
//        if($this->session->userdata('username')=='mafulum'){
