		...
		<div class="col-md-12">
		    <section class="panel">
			    <header class="panel-heading">
					Employee Competency Summary Search
					<span class="tools pull-right">
						<a class="fa fa-chevron-down" href="javascript:;"></a>
					</span>
			    </header>
			    <div class="panel-body" id="divForm">
					<form class="form-horizontal" role="form"  action="<?php echo $base_url; ?>index.php/ecs/search/Y" method="post">
					  ...
					  <table class="table table-bordered table-striped table-condensed cf">
						  ...
						  <tbody>
							<?php if(isset($search)){
								...
								<tr>
								  <td><a href="<?php echo $base_url; ?>index.php/ecs/all/<?php echo $this->global_m->get_array_data($search[$i], "PERNR"); ?>"><?php echo $this->global_m->get_array_data($search[$i], "PERNR"); ?></a></td>
