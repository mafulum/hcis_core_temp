	  ...
	  <aside class="profile-nav col-lg-3">
		  <section class="panel">
			  ...
			  <ul class="nav nav-pills nav-stacked">
				  ...
				  <li><a href="<?php echo $base_url; ?>index.php/gen_pdf/competency_summary/<?php echo $this->global_m->get_array_data($master_emp, "PERNR"); ?>/<?php echo $this->global_m->get_array_data($plansCompare, "PLANS"); ?>"> <i class="fa fa-download"></i> Download Data</a></li>
