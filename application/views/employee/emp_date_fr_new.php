    ...
    <div class="col-lg-12">
        ...
        <section class="panel">
            ...
            <div class="panel-body">
                <form class="form-horizontal" role="form" action="<?php echo $base_url; ?>index.php/employee/emp_date_new" method="post" id="fr_new" name="fr_new">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-10">
                            <input class="form-control form-control-inline input-medium default-date-picker"  size="16" type="text" name="tanggal_masuk" id="tanggal_masuk">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="input7" class="col-lg-2 col-sm-2 control-label">Tgl Kary. Tetap</label>
                        <div class="col-lg-10">
                            <input class="form-control form-control-inline input-medium default-date-picker"  size="16" type="text" name="tanggal_peg_tetap" id="tanggal_peg_tetap">
                        </div>
                    </div>
                <!--    <div class="form-group">
                        <label for="input4" class="col-lg-2 col-sm-2 control-label">MPP</label>
                        <div class="col-lg-10">
                            <input class="form-control form-control-inline input-medium default-date-picker"  size="16" type="text" name="tanggal_mpp" id="tanggal_mpp">
                        </div>
                    </div>	-->
                    <div class="form-group">
                        <label for="input4" class="col-lg-2 col-sm-2 control-label">Pensiun</label>
                        <div class="col-lg-10">
                            <input class="form-control form-control-inline input-medium default-date-picker"  size="16" type="text" name="tanggal_pensiun" id="tanggal_pensiun">
                        </div>
                    </div>
                    <div class="form-group">
