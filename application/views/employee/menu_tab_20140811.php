                ...
                <div class="tab-content tasi-tab">
                    <div class="tab-pane active profile-nav" id="basic">
                        <ul class="nav nav-pills nav-stacked">
                            ...
                            <li><a href="<?php echo base_url() . "index.php/employee/emp_awards_ov/" . $this->global_m->get_array_data($master_emp, "PERNR"); ?>"> <i class="fa fa-caret-square-o-right"></i> Awards</a></li>
