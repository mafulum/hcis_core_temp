    ...
    <div class="col-lg-12">
        ...
        <section class="panel">
            ...
            <div class="panel-body">
                <form class="form-horizontal" role="form"  action="<?php echo $base_url; ?>index.php/memp_tms/personal_overtime_upd" method="post" id="pd_overtime_fr_update" name="pd_overtime_fr_update">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-4">
                            <input size="16" id="begti" name="begti" type="text" value="<?php echo $this->global_m->get_array_data($frm, "BEGTI"); ?>" class="form_datetime form-control">
                        </div>
                        <label for="input3" class="col-lg-2 col-sm-2 control-label">End Time</label>
                        <div class="col-lg-4">
                            <input size="16" id="endti" name="endti" type="text" value="<?php echo $this->global_m->get_array_data($frm, "ENDTI"); ?>" class="form_datetime form-control">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="input3" class="col-lg-2 col-sm-2 control-label">IS WorkDay</label>
                        <div class="col-lg-4">
                            <input type="text" class="form-control" id="ihday" name="ihday" value="<?php echo $this->global_m->get_array_data_num($frm, "IHDAY"); ?>" style="padding: 3px 0px;">
                        </div>
                        <label for="input3" class="col-lg-2 col-sm-2 control-label">Date Payroll</label>
                        <div class="col-lg-4">
                            <input class="form-control form-control-inline input-medium default-date-picker"  size="16" type="text" name="prdpy" id="prdpy" value="<?php echo $this->global_m->get_array_data($frm, "PRDPY"); ?>"/>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="input3" class="col-lg-2 col-sm-2 control-label">Overtime Point</label>
                        <div class="col-lg-2">
                            <input type="text" class="form-control" id="otpnt" name="otpnt" value="<?php echo $this->global_m->get_array_data($frm, "OTPNT"); ?>" style="padding: 3px 0px;">
                        </div>
