    ...
    <div class="col-lg-12">
        ...
        <section class="panel">
            ...
            <div class="panel-body">
                <form class="form-horizontal" role="form"  action="<?php echo $base_url; ?>index.php/employee/emp_compt_upd" method="post" id="fr_update" name="fr_update">
                    <input type="hidden" id="id_ecom" name="id_ecom" value="<?php echo $this->global_m->get_array_data($frm, "id_ecom"); ?>"/> 
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-10">
                            <input type="text" class="form-control" id="compt" name="compt" value="<?php echo $this->global_m->get_array_data($frm, "COMPT"); ?>" style="padding: 3px 0px;">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label for="coval" class="col-lg-2 col-sm-2 control-label">Assesor</label>
                        <div class="col-lg-10">
