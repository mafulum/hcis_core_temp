    ...
    <div class="col-lg-12">
        ...
        <section class="panel">
            ...
            <div class="panel-body">
                <form class="form-horizontal" role="form" action="<?php echo $base_url; ?>index.php/employee/emp_grievances_new" method="post" id="fr_new" name="fr_new">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-10">
                            <input type="text" class="form-control" id="subty" name="subty" value="" style="padding: 3px 0px;">
                        </div>
                    </div>
                    <div class="form-group">
