    ...
    <div class="col-lg-12">
        ...
        <section class="panel">
            ...
            <div class="panel-body">
                <form class="form-horizontal" role="form"  action="<?php echo $base_url; ?>index.php/employee/emp_perf_upd" method="post" id="fr_update" name="fr_update">
                    <input type="hidden" id="id_perf" name="id_perf" value="<?php echo $this->global_m->get_array_data($frm, "id_perf"); ?>"/> 
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-10">
                            <input type="text" class="form-control" id="nilai" name="nilai" value="<?php echo $this->global_m->get_array_data($frm, "NILAI"); ?>">
                        </div>
                    </div>
                    <div class="form-group">
