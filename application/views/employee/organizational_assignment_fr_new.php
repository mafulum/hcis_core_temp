    ...
    <div class="col-lg-12">
        ...
        <section class="panel">
            ...
            <div class="panel-body">
                <form class="form-horizontal" id="fr_new" name="fr_new" role="form" action="<?php echo $base_url; ?>index.php/employee/organizational_assignment_new" method="post">
					...
					<div class="form-group">
                        ...
                        <div class="col-lg-10">
                            <input type="text" class="form-control" id="fwerks" name="fwerks" style="padding: 3px 0px;">
                        </div>
                    </div>
					<div class="form-group">
                    ...
                    <div class="form-group">
                        <label for="input7" class="col-lg-2 col-sm-2 control-label">Payroll Area</label>
                        <div class="col-lg-10">
