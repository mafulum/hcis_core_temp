    ...
    <div class="col-lg-12">
        ...
        <section class="panel">
            ...
            <div class="panel-body">
                <form class="form-horizontal" role="form"  action="<?php echo $base_url; ?>index.php/employee/personal_data_upd" method="post" id="pd_fr_update" name="pd_fr_update">
                    <input type="hidden" id="id_emp" name="id_emp" value="<?php echo $this->global_m->get_array_data($frm, "id_emp"); ?>"/> 
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-10">
                            <input type="radio" name="gesch" id="gesch" value="1" <?php if ($this->global_m->get_array_data($frm, "GESCH") == '1') echo "checked"; ?>> Male
                            <input type="radio" name="gesch" id="gesch" value="2" <?php if ($this->global_m->get_array_data($frm, "GESCH") == '2') echo "checked"; ?>> Female
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="input6" class="col-lg-2 col-sm-2 control-label">Birth Date</label>
                        <div class="col-lg-10">
                            <input class="form-control form-control-inline input-medium default-date-picker" name="gbdat"  size="16" type="text" value="<?php echo $this->global_m->get_array_data($frm, "GBDAT", $this->global_m->DATE_MYSQL); ?>" />
                        </div>
                    </div>
                    <div class="form-group">
                            ...
                            <select class="form-control" id="marst" name="marst" style="padding: 3px 0px;">
                                ...
                                for ($i = 0; $i < count($marst); $i++) {
                                    ...
                                    if($marst[$i]['SHORT']==$this->global_m->get_array_data($frm, "MARST"))
                                            $selected="selected";
                                    echo "<option value='" . $marst[$i]['SHORT'] . "' " . $selected . ">" . $marst[$i]['STEXT'] . " </option>";
                                }
                                ?>
                            </select>
                        </div>
