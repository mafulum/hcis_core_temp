    ...
    <div class="col-lg-12">
        ...
        <section class="panel">
            ...
            <div class="panel-body">
                <form class="form-horizontal" role="form"  action="<?php echo $base_url; ?>index.php/employee/emp_quota_upd" method="post" id="pd_quota_fr_update" name="pd_quota_fr_update">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-4">
                            <input type="text" class="form-control" id="quota" name="quota" value="<?php echo $this->global_m->get_array_data($frm, "QUOTA"); ?>">
                        </div>
