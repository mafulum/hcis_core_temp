    ...
    <div class="col-lg-12">
        ...
        <section class="panel">
            ...
            <div class="panel-body">
                <form class="form-horizontal" role="form" action="<?php echo $base_url; ?>index.php/employee/emp_comm_new" method="post" id="form_fr_new">
                        ...
                        <div class="col-lg-4">
                            <select class="form-control" id="subty" name="subty" style="padding: 3px 0px;">
                                ...
                                for ($i = 0; $i < count($comm_type); $i++) {
                                    echo "<option value='" . $comm_type[$i]['id'] . "' >" . $comm_type[$i]['text'] ."</option>";
                                }
                                ?>
                            </select>
                        </div>
