    ...
    <div class="col-lg-12">
        ...
        <section class="panel">
            ...
            <div class="panel-body">
                <form class="form-horizontal" role="form" action="<?php echo $base_url; ?>index.php/employee/emp_monitoring_new" method="post" new="pd_mot_fr_new" id="pd_bank_fr_new">
                    ...
                    <div class="form-group">
                        <label for="input3" class="col-lg-2 col-sm-2 control-label">Monitoring Type</label>
                        <div class="col-lg-4">
                            <select class="form-control" id="mot" name="mot" style="padding: 3px 0px;">
                                <?php
                                for ($i = 0; $i < count($mot); $i++) {
                                    echo "<option value='" . $mot[$i]['id'] . "' >" . $mot[$i]['text'] ."</option>";
                                }
                                ?>
                            </select>
                        </div>
                        ...
                        <div class="col-lg-4">
                            <input class="form-control form-control-inline input-medium default-date-picker"  size="16" type="text" name="motda" id="motda"/>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="input6" class="col-lg-2 col-sm-2 control-label">SK No</label>
                        <div class="col-lg-4">
                            <input type="text" class="form-control" id="skno" name="skno">
                        </div>
