    ...
    <div class="col-lg-12">
        ...
        <section class="panel">
            ...
            <div class="panel-body">
                <form class="form-horizontal" role="form"  action="<?php echo $base_url; ?>index.php/employee/emp_monitoring_upd" method="post" id="pd_bank_fr_update" name="pd_bank_fr_update">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-4">
                            <select class="form-control" id="mot" name="mot" style="padding: 3px 0px;">
                                <?php
                                for ($i = 0; $i < count($mot); $i++) {
                                    $selected = "";
                                    if($mot[$i]['id']==$this->global_m->get_array_data($frm, "REMINDER_TYPE"))
                                            $selected="selected";
                                    echo "<option value='" . $mot[$i]['id'] . "' " . $selected . ">" . $mot[$i]['text'] . " </option>";
                                }
                                ?>
                            </select>
                        </div>
                        ...
                        <div class="col-lg-4">
                            <input class="form-control form-control-inline input-medium default-date-picker"  size="16" type="text" name="motda" id="motda" value="<?php echo $this->global_m->get_array_data($frm, "REMINDER_DATE", $this->global_m->DATE_MYSQL); ?>"/>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="input4" class="col-lg-2 col-sm-2 control-label">SK.No</label>
                        <div class="col-lg-4">
                            <input type="text" class="form-control" id="skno" name="skno" value="<?php echo $this->global_m->get_array_data($frm, "SK_NO"); ?>">
                        </div>
