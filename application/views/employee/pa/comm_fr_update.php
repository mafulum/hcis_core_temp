    ...
    <div class="col-lg-12">
        ...
        <section class="panel">
            ...
            <div class="panel-body">
                <form class="form-horizontal" role="form"  action="<?php echo $base_url; ?>index.php/employee/emp_comm_upd" method="post" id="form_fr_update">
                    <input type="hidden" id="id" name="id" value="<?php echo $this->global_m->get_array_data($frm, "emp_comm_id"); ?>"/> 
                    ...
                    <div class="form-group">
                            ...
                            <select class="form-control" id="subty" name="subty" style="padding: 3px 0px;">
                                ...
                                for ($i = 0; $i < count($comm_type); $i++) {
                                    ...
                                    if($comm_type[$i]['id']==$this->global_m->get_array_data($frm, "SUBTY"))
                                            $selected="selected";
                                    echo "<option value='" . $comm_type[$i]['id'] . "' " . $selected . ">" . $comm_type[$i]['text'] . " </option>";
                                }
                                ?>
                            </select>
                        </div>
                        ...
                        <div class="col-lg-4">
                            <input type="text" class="form-control" id="usrid" name="usrid" value="<?php echo $this->global_m->get_array_data($frm, "USRID"); ?>">
                        </div>
                    </div>
                    <div class="form-group">
