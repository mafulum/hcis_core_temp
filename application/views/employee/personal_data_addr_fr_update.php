    ...
    <div class="col-lg-12">
        ...
        <section class="panel">
            ...
            <div class="panel-body">
                <form class="form-horizontal" role="form"  action="<?php echo $base_url; ?>index.php/employee/personal_data_addr_upd" method="post" id="pd_fr_update" name="pd_fr_update">
                    <input type="hidden" id="id_emp" name="id_addr" value="<?php echo $this->global_m->get_array_data($frm, "id_addr"); ?>"/> 
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-10">
                            <input type="radio" name="address_type" value="HOME" <?php if ($this->global_m->get_array_data($frm, "ADDRESS_TYPE") == 'HOME') echo "checked"; ?>> Home
                            <input type="radio" name="address_type" value="OFFC" <?php if ($this->global_m->get_array_data($frm, "ADDRESS_TYPE") == 'OFFC') echo "checked"; ?>> Office
                        </div>
                    </div>
                    <div class="form-group">
