    ...
    <div class="col-lg-12">
        ...
        <section class="panel">
            <header class="panel-heading">
                Personal Data
                <?php if($this->common->check_permission('EmployeeMasterData.Personal.PersonalData.Maintain')){ ?>
                    ...
                    if (count($ov) == 0) {
                        ...
                        for ($i = 0; $i < count($ov); $i++) {
                            ...
                            <tr>
                                ...
                                <td><?php echo $this->global_m->get_array_data($ov[$i], "AGE"); ?></td>
                                <td>
                                    <?php if($this->common->check_permission('EmployeeMasterData.Personal.PersonalData.View')){ ?>
                                    <a class="btn btn-primary btn-xs" href="<?= base_url(); ?>index.php/employee/personal_data_view/<?php echo $this->global_m->get_array_data($master_emp, "PERNR"); ?>/<?php echo $this->global_m->get_array_data($ov[$i], 'id_emp'); ?>" data-toggle="modal"> <i class="fa fa-search"></i> </a>
                                    <?php } if($this->common->check_permission('EmployeeMasterData.Personal.PersonalData.Maintain')){ ?>
                                    ...
                                    <a class="btn btn-danger btn-xs" href="#" onclick="confirm_delete('<?= base_url(); ?>index.php/employee/personal_data_del/<?php echo $this->global_m->get_array_data($master_emp, "PERNR"); ?>/<?php echo $this->global_m->get_array_data($ov[$i], 'id_emp'); ?>');" data-toggle="modal"> <i class="fa fa-trash-o"></i> </a>
                                    <?php } ?>
                                </td>
                            </tr>
                            <?php
