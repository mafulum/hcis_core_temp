    ...
    <div class="col-lg-12">
        ...
        <section class="panel">
            ...
            <div class="panel-body">
                <form class="form-horizontal" role="form"  action="<?php echo $base_url; ?>index.php/memp_payroll/personal_npwp_upd" method="post" id="pd_npwp_fr_update" name="pd_npwp_fr_update">
                    <input type="hidden" id="id_emp_tax" name="id_emp_tax" value="<?php echo $this->global_m->get_array_data($frm, "id_emp_tax"); ?>"/> 
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-10">
                            <input type="text" class="form-control" id="cTaxid" name="cTaxid" value="<?php echo $this->global_m->get_array_data($frm, "TAXID"); ?>">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="input3" class="col-lg-2 col-sm-2 control-label">Reg. Date</label>
                        <div class="col-lg-10">
                            <input class="form-control form-control-inline input-medium default-date-picker"  size="16" type="text" name="cRdate" id="cRdate" value="<?php echo $this->global_m->get_array_data($frm, "RDATE", $this->global_m->DATE_MYSQL); ?>"/>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="input7" class="col-lg-2 col-sm-2 control-label">Reff PTKP</label>
                        <div class="col-lg-10">
                            <select class="form-control" id="fptkp" name="fptkp" style="padding: 3px 0px;">
                                <?
                                for ($i = 0; $i < count($fptkp); $i++) {
                                    $selected = "";
                                    if($fptkp[$i]['id']==$this->global_m->get_array_data($frm, "DEPND"))
                                            $selected="selected";
                                    echo "<option value='" . $fptkp[$i]['id'] . "' " . $selected . ">" . $fptkp[$i]['text'] . " </option>";
                                }
                                ?>
                            </select>
                        </div>
