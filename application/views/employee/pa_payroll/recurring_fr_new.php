    ...
    <div class="col-lg-12">
        ...
        <section class="panel">
            ...
            <div class="panel-body">
                <form class="form-horizontal" role="form" action="<?php echo $base_url; ?>index.php/memp_payroll/personal_recurring_new" method="post" new="pd_recurring_fr_new" id="pd_recurring_fr_new">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-4">
                            <input type="text" class="form-control" id="wamnt" name="wamnt" value="">
                        </div>
                        <label for="input3" class="col-lg-2 col-sm-2 control-label">Percent</label>
                        <div class="col-lg-4">
                            <input type="text" class="form-control" id="wapct" name="wapct" value="">
                        </div>
                    </div>
                    <div class="form-group">
