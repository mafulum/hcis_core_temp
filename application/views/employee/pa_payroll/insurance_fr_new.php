    ...
    <div class="col-lg-12">
        ...
        <section class="panel">
            ...
            <div class="panel-body">
                <form class="form-horizontal" role="form" action="<?php echo $base_url; ?>index.php/memp_payroll/personal_insurance_new" method="post" new="pd_insurance_fr_new" id="pd_insurance_fr_new">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-4">
                            <input type="text" class="form-control" id="prcte" name="prcte" value="1">
                        </div>
                        <label for="input3" class="col-lg-2 col-sm-2 control-label">% Company</label>
                        <div class="col-lg-4">
                            <input type="text" class="form-control" id="prcte" name="prctc" value="4">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="input3" class="col-lg-2 col-sm-2 control-label">Max Employee</label>
                        <div class="col-lg-4">
                            <input type="text" class="form-control" id="prcte" name="maxre" value="120000">
                        </div>
                        <label for="input3" class="col-lg-2 col-sm-2 control-label">Max Company</label>
                        <div class="col-lg-4">
                            <input type="text" class="form-control" id="prcte" name="maxrc" value="480000">
                        </div>
                    </div>
                    <div class="form-group">
