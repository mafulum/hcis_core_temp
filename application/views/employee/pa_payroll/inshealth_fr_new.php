    ...
    <div class="col-lg-12">
        ...
        <section class="panel">
            ...
            <div class="panel-body">
                <form class="form-horizontal" role="form" action="<?php echo $base_url; ?>index.php/memp_payroll/personal_inshealth_new" method="post" new="pd_inshealth_fr_new" id="pd_inshealth_fr_new">
                    ...
                    <div class="form-group">
                        <label for="input3" class="col-lg-2 col-sm-2 control-label">ID BPJS Kes / Asuransi</label>
                        <div class="col-lg-10">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-10">
                            <select class="form-control" id="fam" name="fam" style="padding: 3px 0px;">
                                <option value="9999">Self Employee</option>
                                <?php
