    ...
    <div class="col-lg-12">
        ...
        <section class="panel">
            ...
            <div class="panel-body">
                <form class="form-horizontal" role="form" action="<?php echo $base_url; ?>index.php/memp_payroll/personal_addpayment_new" method="post" new="pd_addpayment_fr_new" id="pd_addpayment_fr_new">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-4">
                            <input class="form-control form-control-inline input-medium default-date-picker"  size="16" type="text" name="begda" id="begda"/>
                        </div>
                        <label for="input3" class="col-lg-2 col-sm-2 control-label">Event Date</label>
                        <div class="col-lg-4">
                            <input class="form-control form-control-inline input-medium default-date-picker"  size="16" type="text" name="evtda" id="evtda"/>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-lg-4">
                            <select class="form-control" id="wgtyp" name="wgtyp" style="padding: 3px 0px;">
                                ...
                                for ($i = 0; $i < count($wgtyps); $i++) {
                                    echo "<option value='" . $wgtyps[$i]['WGTYP'] . "'>" . $wgtyps[$i]['LGTXT'] . " ( ".$wgtyps[$i]['WGTYP']." ) </option>";
                                }
                                ?>
                            </select>   
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-4">
                            <input type="text" class="form-control" id="wamnt" name="wamnt">
                        </div>
                        <label for="input3" class="col-lg-2 col-sm-2 control-label">Point</label>
                        <div class="col-lg-4">
                            <input type="text" class="form-control" id="wapnt" name="wapnt">
                        </div>
                    </div>
                    <div class="form-group">
