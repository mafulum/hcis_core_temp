    ...
    <div class="col-lg-12">
        ...
        <section class="panel">
            ...
            <div class="panel-body">
                <form class="form-horizontal" role="form" action="<?php echo $base_url; ?>index.php/memp_payroll/personal_npwp_new" method="post" new="pd_npwp_fr_new" id="pd_npwp_fr_new">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-10">
                            <input type="text" class="form-control" id="cTaxid" name="cTaxid">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="input3" class="col-lg-2 col-sm-2 control-label">Reg. Date</label>
                        <div class="col-lg-10">
                            <input class="form-control form-control-inline input-medium default-date-picker"  size="16" type="text" name="cRdate" id="cRdate"/>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="input6" class="col-lg-2 col-sm-2 control-label">Reff PTKP</label>
                        <div class="col-lg-10">
                            <select class="form-control" id="fptkp" name="fptkp" style="padding: 3px 0px;">
                                <?
                                for ($i = 0; $i < count($fptkp); $i++) {
                                    echo "<option value='" . $fptkp[$i]['id'] . "' >" . $fptkp[$i]['text'] ."</option>";
                                }
                                ?>
                            </select>
                        </div>
