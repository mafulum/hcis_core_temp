    ...
    <div class="col-lg-12">
        ...
        <section class="panel">
            ...
            <div class="panel-body">
                <form class="form-horizontal" role="form"  action="<?php echo $base_url; ?>index.php/memp_payroll/personal_bpjs_tk_upd" method="post" id="pd_bpjs_tk_fr_update" name="pd_bpjs_tk_fr_update">
                    <input type="hidden" id="id_emp_bpjs_tk" name="id_emp_bpjs_tk" value="<?php echo $this->global_m->get_array_data($frm, "id_emp_bpjs_tk"); ?>"/> 
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-4">
                            <input type="text" class="form-control" id="bpjsid" name="bpjsid" value="<?php echo $this->global_m->get_array_data($frm, "BPJSID"); ?>">
                        </div>
                        <label for="input3" class="col-lg-2 col-sm-2 control-label">Facilty Type</label>
                        <div class="col-lg-4">
                            <input type="text" class="form-control" id="fclty" name="fclty" value="<?php echo $this->global_m->get_array_data($frm, "FCLTY"); ?>">
                        </div>
                    </div>
                    <div class="form-group">
