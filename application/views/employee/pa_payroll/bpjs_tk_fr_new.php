    ...
    <div class="col-lg-12">
        ...
        <section class="panel">
            ...
            <div class="panel-body">
                <form class="form-horizontal" role="form" action="<?php echo $base_url; ?>index.php/memp_payroll/personal_bpjs_tk_new" method="post" new="pd_bpjs_tk_fr_new" id="pd_bpjs_tk_fr_new">
                    ...
                    <div class="form-group">
                        <label for="input3" class="col-lg-2 col-sm-2 control-label">No BPJS TK</label>
                        <div class="col-lg-4">
                            <input type="text" class="form-control" id="bpjsid" name="bpjsid">
                        </div>
                        <label for="input3" class="col-lg-2 col-sm-2 control-label">Facilty Type</label>
                        <div class="col-lg-4">
                            <input type="text" class="form-control" id="fclty" name="fclty" value="">
                        </div>`
                    </div>
                    <div class="form-group">
                        <label for="input3" class="col-lg-2 col-sm-2 control-label">Reg. Date</label>
                        <div class="col-lg-4">
                            <input class="form-control form-control-inline input-medium default-date-picker"  size="16" type="text" name="rdate" id="rdate"/>
                        </div>
                    </div>
                    <div class="form-group">
