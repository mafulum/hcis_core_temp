            ...
            <div class="panel-body">
                <div class="tab-content tasi-tab">
                    ...
                    <div class="tab-pane profile-nav" id="org">
                        <ul class="nav nav-pills nav-stacked">
                            <li><a href="<?php echo base_url() . "index.php/employee/organizational_assignment_ov/" . $this->global_m->get_array_data($master_emp, "PERNR"); ?>"> <i class="fa fa-caret-square-o-right"></i> Organizational Assignment</a></li>
                            ...
                            <li><a href="<?php echo base_url() . "index.php/employee/date_specification_ov/" . $this->global_m->get_array_data($master_emp, "PERNR"); ?>""> <i class="fa fa-caret-square-o-right"></i> Date Specification</a></li>
                        </ul>
                    </div>
