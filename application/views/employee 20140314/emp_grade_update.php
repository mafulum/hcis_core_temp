    ...
    <div class="col-lg-12">
        ...
        <section class="panel">
            ...
            <div class="panel-body">
                <form class="form-horizontal" role="form"  action="<?php echo $base_url; ?>index.php/employee/emp_org_upd" method="post">
                    <input type="hidden" name="id_otheras" value="<?php echo $this->global_m->get_array_data($frm, "id_egrd"); ?>"/> 
                    ...
                    <div class="form-group">
                        <label for="input4" class="col-lg-2 col-sm-2 control-label">Status</label>
                        <div class="col-lg-10">
