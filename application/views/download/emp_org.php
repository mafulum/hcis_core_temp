        ...
        <div class="col-lg-12">
            ...
            <section class="panel">
                <header class="panel-heading">
                    Download Employee Org.
                </header>
                <div class="panel-body">
                    <form class="form-horizontal" role="form"  action="<?php echo $base_url; ?>index.php/download/emp_org/download" method="post" id="org_new"  enctype="multipart/form-data">
