        ...
        <div class="col-lg-12">
            <section class="panel">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" id="fr_update" name="fr_update" action="<?php echo $base_url; ?>index.php/admin/mreadiness_upd" method="post"> 
                        <input type="hidden" name="id_readiness" value="<?php echo $this->global_m->get_array_data($frm, "id_readiness"); ?>"/>
