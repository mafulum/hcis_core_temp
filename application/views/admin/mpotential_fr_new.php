        ...
        <div class="col-lg-12">
            <section class="panel">
                <header class="panel-heading">
                    Master Potential [ADD NEW]
                </header>
                <div class="panel-body">
                    <form class="form-horizontal" role="form" id="fr_insert" name="fr_insert" action="<?php echo $base_url; ?>index.php/admin/mpotential_new" method="post">
