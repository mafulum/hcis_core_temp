        ...
        <div class="col-lg-12">
            <section class="panel">
                <header class="panel-heading">
                    Master Potential [UPDATE]
                </header>
                <div class="panel-body">
                    <form class="form-horizontal" role="form" id="fr_update" name="fr_update" action="<?php echo $base_url; ?>index.php/admin/mpotential_upd" method="post">
                        <input type="hidden" name="id_pot" value="<?php echo $this->global_m->get_array_data($frm, "id_pot"); ?>"/>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <div class="input-group input-large">
                                    <input type="text" class="form-control" name="MIN"  value="<?php echo $this->global_m->get_array_data($frm, "MIN"); ?>">
                                    <span class="input-group-addon">To</span>
                                    <input type="text" class="form-control" name="MAX" value="<?php echo $this->global_m->get_array_data($frm, "MAX"); ?>">
                                </div>
                                <span class="help-block">Range Level</span>
                            </div>
                        </div>
                        <div class="form-group">
            ...
            <a class="btn btn-default" href="<?php echo base_url() . "index.php/admin/mpotential"; ?>" data-toggle="modal"> <i class=" fa fa-chevron-left"> Back</i> </a>
        </div>
