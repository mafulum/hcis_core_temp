<section class="wrapper">
    <div class="col-lg-12">
        <section class="panel">
            ...
            <form class="form-horizontal" role="form"  action="<?php echo $base_url; ?>index.php/splan/variant_new" method="post" id="user_fr_new">
                <div class="panel-body">
                    <div class="form-group">
                        <label for="username" class="col-lg-2 col-sm-2 control-label">Name</label>
                        <div class="col-lg-10">
