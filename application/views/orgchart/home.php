            ...
            <section class="panel">
                ...
                <div class="panel-body">
                    <div class="tab-content tasi-tab">
                        ...
                        <div class="tab-pane profile-nav" id="oAdditionalRelationship">
                            ...
                            <div class="panel">
                                ...
                                <div class="panel-body">
                                    <form class="form-horizontal" id="fPos" role="form"  action="<?php echo $base_url; ?>index.php/orgchart/update_pos" method="post">
                                        ...
                                        <div class="form-group fortad">
                                            <label for="input5" class="col-lg-2 col-sm-2 control-label">Reff Kontrak</label>
                                            <div class="col-lg-10">                                                
                                                <input type="text" class="form-control" id="cReffKontrak" name="cReffKontrak" value="">
                                            </div>
                                        </div>
                                        <div class="form-group fortad">
                                            <label for="input6" class="col-lg-2 col-sm-2 control-label">Email Superior</label>
                                            <div class="col-lg-10">                                                
                                                <input type="text" class="form-control" id="cEmailSup" name="cEmailSup" value="">
                                            </div>
                                        </div>
                                        <div class="form-group fortad">
                                            <label for="input5" class="col-lg-2 col-sm-2 control-label">Nama Superior</label>
                                            <div class="col-lg-10">
                                                <input type="text" class="form-control" id="cNameSup" name="cNameSup" value="">
                                            </div>
                                        </div>
                                    </form>
