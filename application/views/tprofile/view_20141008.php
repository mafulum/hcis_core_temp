	  ...
	  <aside class="profile-info col-lg-9">
		  <section class="panel">
			  <div class="bio-graph-heading">
				  Pupuk Indonesia Talent Profile
			  </div>
			  <div class="panel-body bio-graph-info">
				  <div class="row">
					  <div class="bio-row">
						  ...
						  <p><span>NIK Asal </span>: <?php echo $this->global_m->get_array_data($emp_map, "NIK"); ?></p>
						  ...
						  <p><span>Tgl. Pensiun </span>: <?php echo $this->global_m->get_array_data($empDate, "TTanggalMPP"); ?> </p>
						  <p><span>Tgl. MPP </span>: <?php echo $this->global_m->get_array_data($empDate, "TTanggalPensiun"); ?> </p>
					  ...
					  <div class="bio-row">
						  ...
						  <ul>
							...
							<li>Description : <?php echo $this->global_m->get_array_data($talentMap, "STEXT"); ?> (<?php echo $this->global_m->get_array_data($talentMap, "SHORT"); ?>)
						  ...
						  <ul>
							<?php for ($i = 0; $i < count($training); $i++) { ?>
								...
								<?php echo $this->global_m->get_array_data($training[$i], "TBEGDA"); ?> - <?php echo $this->global_m->get_array_data($training[$i], "TENDDA"); ?>,
								<?php echo ucwords(strtolower($this->global_m->get_array_data($training[$i], "SLTP1"))); ?>,
								<?php echo ucwords(strtolower($this->global_m->get_array_data($training[$i], "INSTI"))); ?>
								</li>
							<?php } ?>
						  </ul>
						  <?php
